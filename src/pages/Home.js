    ...
    <>
      ...
      <Container>
        ...
        <Row className="text-center">
          ...
          <Col sm={8}>
            <p className="red_text">
              <span className="p_span">OUR STORY</span>
            </p>
          </Col>
        ...
        <Row className="text-center">
          ...
          <Col sm={8}>
            <p className="red_text">
              <span className="p_span">TOYS</span>
            </p>
          </Col>
        </Row>
      </Container>
      <Container>
        <Row className="text-center">
          <Col sm={4}>
            {" "}
            <img src={Icon1} className="home_subimage" loading="lazy" />{" "}
          </Col>
          <Col sm={4}>
            {" "}
            <img src={Icon2} className="home_subimage" loading="lazy" />{" "}
          </Col>
          <Col sm={4}>
            {" "}
            <img src={Icon6} className="home_subimage" loading="lazy" />{" "}
          </Col>
        </Row>
        <br />
        <br />
        ...
        <Row className="text-center">
          <Col sm={4}>
            {" "}
            <img src={Icon4} className="home_subimage" loading="lazy" />{" "}
          </Col>
          <Col sm={4}>
            {" "}
            <img src={Icon5} className="home_subimage" loading="lazy" />{" "}
          </Col>
          <Col sm={4}>
            {" "}
            <img src={Icon3} className="home_subimage" loading="lazy" />{" "}
          </Col>
        </Row>
